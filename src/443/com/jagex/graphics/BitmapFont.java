...
public class BitmapFont extends DrawingArea
{
    ...
    public static JString aClass3_2432
	= JString.create("mag");
	...
	if (class3 != null) {
		...
		if (class3.bytes[i_48_] == 64
		    ...
		    int i_49_
			= getColor(class3.substring(i_48_ + 1, i_48_ + 4));
		    if (i_49_ != -1)
			i_41_ = i_49_;
		    i_48_ += 4;
		} else {
	...
	if (class3 != null) {
		...
		if (class3.bytes[i_54_] == 64
		    ...
		    int i_55_
			= getColor(class3.substring(i_54_ + 1, i_54_ + 4));
		    if (i_55_ != -1)
			i_52_ = i_55_;
		    i_54_ += 4;
		} else {
	...
	if (class3 != null) {
		...
		if (class3.bytes[i_69_] == 64
		    ...
		    int i_70_
			= getColor(class3.substring(i_69_ + 1, i_69_ + 4));
		    if (i_70_ != -1)
			i_66_ = i_70_;
		    i_69_ += 4;
		} else {
	...
	for (int i_126_ = 0; i_126_ < i_125_; i_126_++) {
		...
		aClass3Array2440[i_124_++]
		    = class3_117_.substring
		...
		if (bool && i_115_ > i && i_118_ >= 0) {
		    aClass3Array2440[i_124_++]
			= class3_117_.substring(i_116_, i_118_)
			      .method69();
		    i_116_ = i_118_;
		    i_118_ = -1;
		    i_115_ -= i_119_;
