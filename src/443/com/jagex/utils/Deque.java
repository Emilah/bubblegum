...
public class Deque {
    ...
    public static int[] anIntArray911 = {12800, 12800, 12800, 12800, 12800, 12800, 12800, 12800, 12800,
    ...
    public static boolean drawWidgets(int i, int i_3_, int offsetX, int i_5_,
        ...
        return Class20.drawWidgets((AbstractMidiHandler.widgets[i_5_]),
    ...
    public static void method958(byte i, int i_9_) {
        ...
        for (int i_12_ = 1; i_12_ < 103; i_12_++) {
            ...
            for (int i_14_ = 1; i_14_ < 103; i_14_++) {
                ...
                if (i_9_ < 3 && ((TextureLoaderImpl.tileFlags[i_9_ + 1][i_14_][i_12_])
                        & 0x8) != 0) {
        ...
        for (int i_17_ = 1; i_17_ < 103; i_17_++) {
            for (int i_18_ = 1; i_18_ < 103; i_18_++) {
                ...
                if (i_9_ < 3 && ((TextureLoaderImpl.tileFlags[i_9_ + 1][i_18_][i_17_])
                        & 0x8) != 0) {
        ...
        for (int i_19_ = 0; i_19_ < 104; i_19_++) {
            for (int i_20_ = 0; i_20_ < 104; i_20_++) {
                ...
                if (i_21_ != 0) {
                    ...
                    int i_22_ = JCanvas.getObjectDefinition(i_21_).anInt1962;
                    if (i_22_ >= 0) {
                        int i_23_ = i_20_;
                        int i_24_ = i_19_;
                        if (i_22_ != 22 && i_22_ != 29 && i_22_ != 34
                                ...
                                && i_22_ != 48) {
                            int[][] is_25_ = (Class39_Sub5_Sub12.traversalMaps[NameTable.height].adjancency);
                        ...
                        MouseRecorder.aClass39_Sub5_Sub10_Sub3Array560[anInt915] = (Projectile.aClass39_Sub5_Sub10_Sub3Array2205[i_22_]);
    ...
    public static void loadLandscapeTile(Buffer buffer, int i_29_,
            ...
            for (;;) {
                ...
                if (i_36_ == 0) {
                    if (height != 0) {
                        ...
                        Class67.heightMap[0][x][y] = (-AudioHandler.getPerlinNoise(i_32_ + y + 556238,
                                932731 + x + i_30_, 1)
                                * 8);
                    }
                    break;
                ...
                if (i_36_ == 1) {
                    ...
                    if (height != 0) {
                        Class67.heightMap[height][x][y] = (Class67.heightMap[height - 1][x][y]) - i_37_ * 8;
                    } else {
                        Class67.heightMap[0][x][y] = -i_37_ * 8;
                    }
                    break;
                }
                if (i_36_ <= 49) {
                    ...
                    TextureLoaderImpl.tileFlags[height][x][y] = (byte) (i_36_ - 49);
                } else {
                    Class39_Sub14.aByteArrayArrayArray1516[height][x][y] = (byte) (i_36_ - 81);
                }
            }
        }
    }
