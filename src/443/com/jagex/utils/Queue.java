...
public class Queue
{
	...
	= JString.create(",Zffentlicher Chat");
	...
	(boolean bool, Mob class39_sub5_sub4_sub4) {
	...
	aClass3_990
	    = JString.create("Connection timed out)3");
	aClass3_977 = aClass3_985;
	aClass3_991
	    = JString.create("Bitte warten Sie)3)3)3");
