...
public class NameTable {
    ...
    public static Class39_Sub5_Sub12 method182(int i, AbstractFileLoader class9, AbstractFileLoader class9_0_, int i_1_, boolean bool) {
    ...
    static {
        ...
        aClass3_181 = JString.create("Ladevorgang )2 bitte warten Sie)3");
        objectDefinitionCache = new Cache(64);
        aClass3_188 = JString.create("Lade Schrifts-=tze )2 ");
        aClass3_189 = JString.create("Loading )2 please wait)3");
