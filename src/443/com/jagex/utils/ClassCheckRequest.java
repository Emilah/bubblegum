...
public class ClassCheckRequest extends Node {
    ...
    public static void decodeSprite(byte[] is) {
        ...
        for (int i_3_ = 0; JSocket.anInt302 > i_3_; i_3_++) {
            Class39_Sub5_Sub9.anIntArray1799[i_3_] = class39_sub6.getUint16();
        }
        for (int i_4_ = 0; i_4_ < JSocket.anInt302; i_4_++) {
            Class39_Sub14.anIntArray1512[i_4_] = class39_sub6.getUint16();
        }
        class39_sub6.offset = 3 - i_0_ * 3 + (is.length - 7 - JSocket.anInt302 * 8);
        StillObject.anIntArray1460 = new int[i_0_];
        for (int i_5_ = 1; i_0_ > i_5_; i_5_++) {
            StillObject.anIntArray1460[i_5_] = class39_sub6.getUint24();
            ...
            if (i_11_ == 0) {
                ...
                for (int i_13_ = 0; i_13_ < i_8_; i_13_++) {
                    for (int i_14_ = 0; i_14_ < i_7_; i_14_++) {
                        is_10_[i_8_ * i_14_ + i_13_] = class39_sub6.getInt8();
                    }
                }
            }
        }
    ...
    public static void method846(Mob class39_sub5_sub4_sub4,
        ...
        if (class39_sub5_sub4_sub4.anInt2303 != -1) {
            Class39_Sub5_Sub11 class39_sub5_sub11 = AbstractMidiHandler.method1064(class39_sub5_sub4_sub4.anInt2303,
                    (byte) 54);
            if (class39_sub5_sub11 != null
                ...
                if ((class39_sub5_sub4_sub4.anInt2306
                        ...
                        && ((class39_sub5_sub11.anIntArray1831[class39_sub5_sub4_sub4.anInt2306])
                        < class39_sub5_sub4_sub4.anInt2283)) {
        ...
        if (class39_sub5_sub4_sub4.anInt2270 != -1
            ...
            int i_15_ = (Huffman.method881(i ^ 0xf4240, class39_sub5_sub4_sub4.anInt2270).anInt2126);
            if (i_15_ != -1) {
                Class39_Sub5_Sub11 class39_sub5_sub11 = AbstractMidiHandler.method1064(i_15_, (byte) 54);
                if (class39_sub5_sub11 != null
                        && class39_sub5_sub11.anIntArray1833 != null) {
                    ...
                    if ((class39_sub5_sub4_sub4.anInt2276
                            < class39_sub5_sub11.anIntArray1833.length)
                            && (class39_sub5_sub4_sub4.anInt2304
                            > (class39_sub5_sub11.anIntArray1831[class39_sub5_sub4_sub4.anInt2276]))) {
        ...
        if (class39_sub5_sub4_sub4.anInt2268 != -1
            ...
            Class39_Sub5_Sub11 class39_sub5_sub11 = AbstractMidiHandler.method1064(class39_sub5_sub4_sub4.anInt2268,
                    (byte) 54);
        ...
        if (class39_sub5_sub4_sub4.anInt2268 != -1
            ...
            if (class39_sub5_sub11 != null
                ...
                if ((class39_sub5_sub11.anIntArray1833.length
                        ...
                        && ((class39_sub5_sub11.anIntArray1831[class39_sub5_sub4_sub4.anInt2265])
                        < class39_sub5_sub4_sub4.anInt2311)) {
                    class39_sub5_sub4_sub4.anInt2265++;
                ...
                if (class39_sub5_sub4_sub4.anInt2265
                    ...
                    class39_sub5_sub4_sub4.anInt2265 -= class39_sub5_sub11.anInt1839;
                ...
                class39_sub5_sub4_sub4.aBoolean2298 = class39_sub5_sub11.aBoolean1838;
            } else {
                class39_sub5_sub4_sub4.anInt2268 = -1;
            }
        }
    ...
    public static void reportError(Throwable throwable, String string) {
        do {
            try {
                ...
                error = error.replace('&', '_');
                error = error.replace('#', '_');
                Resource resource = (Cache.webSignlink.requestDataInputStream(new URL(Cache.webSignlink.anApplet416.getCodeBase(), ("clienterror.ws?c=" + ArchiveWorker.anInt1198 + "&u=" + Client.encodedUsername + "&v1="
                        + Signlink.javaVendor + "&v2="
                        + Signlink.javaVersion + "&e=" + error))));
                while (resource.returnCode == 0) {
                    PlayerApperance.sleep(1L);
                }
                if (resource.returnCode != 1) {
                    break;
                }
                DataInputStream datainputstream = (DataInputStream) resource.returnObject;
    ...
    public static int method851(int i, int i_23_, int i_24_, int i_25_,
            int i_26_) {
        int i_27_ = (65536 - TriangleRasterizer.cosineTable[i * 1024 / i_25_]
                >> 1);
        return ((-i_27_ + 65536) * i_24_ >> 16) + (i_27_ * i_23_ >> 16);
    }

    public static DirectColorSprite[] method852(JString class3, AbstractFileLoader class9, JString class3_28_, int i) {
