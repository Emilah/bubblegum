...
public class PlayerApperance {
    ...
    public Model method922(int i, Class39_Sub5_Sub11 class39_sub5_sub11,
            Class39_Sub5_Sub11 class39_sub5_sub11_6_, int i_7_, int i_8_) {
        if (anInt852 != -1) {
            return (ArchiveWorker.getNpcDefinition(anInt852).method725(i_7_, 65535, class39_sub5_sub11, class39_sub5_sub11_6_,
                    i_8_));
        }
        long l = aLong849;
        ...
        Model class39_sub5_sub4_sub6 = ((Model) JRuntimeException.aClass7_1220.get(l));
        if (class39_sub5_sub4_sub6 == null) {
            ...
            if (bool) {
                if (aLong850 != -1L) {
                    class39_sub5_sub4_sub6 = ((Model) JRuntimeException.aClass7_1220
                            .get(aLong850));
                }
                if (class39_sub5_sub4_sub6 == null) {
                    return null;
            ...
            if (class39_sub5_sub4_sub6 == null) {
                Model[] class39_sub5_sub4_sub6s = new Model[12];
                int i_12_ = 0;
                for (int i_13_ = 0; i_13_ < 12; i_13_++) {
                    int i_14_ = is[i_13_];
                    if (i_14_ >= 256 && i_14_ < 512) {
                        Model class39_sub5_sub4_sub6_15_ = FileLoader.method172(i_14_ - 256, 3)
                                .method580(114);
                        if (class39_sub5_sub4_sub6_15_ != null) {
                            class39_sub5_sub4_sub6s[i_12_++] = class39_sub5_sub4_sub6_15_;
                        }
                    }
                    if (i_14_ >= 512) {
                        Model class39_sub5_sub4_sub6_16_ = Class26.getItemDefinition(i_14_ - 512)
                                .method474(isMale, i ^ ~0x6bfa);
                        if (class39_sub5_sub4_sub6_16_ != null) {
                            class39_sub5_sub4_sub6s[i_12_++] = class39_sub5_sub4_sub6_16_;
                        }
                    }
                }
                ...
                for (int i_17_ = 0; i_17_ < 5; i_17_++) {
                    if (anIntArray851[i_17_] != 0) {
                        class39_sub5_sub4_sub6.method563((GroundItem.anIntArrayArray2233[i_17_][0]),
                                (GroundItem.anIntArrayArray2233[i_17_][anIntArray851[i_17_]]));
                        if (i_17_ == 1) {
                            class39_sub5_sub4_sub6.method563(MsTimer.anIntArray1555[0],
                                    (MsTimer.anIntArray1555[anIntArray851[i_17_]]));
                        }
                    }
                }
        ...
        if (class39_sub5_sub11_6_ != null || class39_sub5_sub11 != null) {
            if (class39_sub5_sub11_6_ != null && class39_sub5_sub11 != null) {
                class39_sub5_sub4_sub6_18_ = class39_sub5_sub11_6_.method701(i_7_,
                        class39_sub5_sub4_sub6,
                        class39_sub5_sub11,
                        i - 248981919, i_8_);
            } else if (class39_sub5_sub11_6_ == null) {
                class39_sub5_sub4_sub6_18_ = class39_sub5_sub11.method703(class39_sub5_sub4_sub6,
                        i_8_, true);
            } else {
                class39_sub5_sub4_sub6_18_ = class39_sub5_sub11_6_.method703(class39_sub5_sub4_sub6,
                        i_7_, true);
            }
        } else {
    ...
    public Model method924(int i) {
        ...
        for (int i_23_ = 0; i_23_ < 12; i_23_++) {
            ...
            if (i_24_ >= 256 && i_24_ < 512) {
                Model class39_sub5_sub4_sub6 = FileLoader.method172(i_24_ - 256, 3)
                        .method576(i ^ ~0x1);
                if (class39_sub5_sub4_sub6 != null) {
            ...
            if (i_24_ >= 512) {
                Model class39_sub5_sub4_sub6 = Class26.getItemDefinition(i_24_ - 512)
        ...
        Model class39_sub5_sub4_sub6 = new Model(class39_sub5_sub4_sub6s, i_22_);
        for (int i_25_ = 0; i_25_ < 5; i_25_++) {
            if (anIntArray851[i_25_] != 0) {
                class39_sub5_sub4_sub6.method563((GroundItem.anIntArrayArray2233[i_25_][0]),
                        (GroundItem.anIntArrayArray2233[i_25_][anIntArray851[i_25_]]));
                if (i_25_ == 1) {
                    class39_sub5_sub4_sub6.method563((MsTimer.anIntArray1555[0]),
                            (MsTimer.anIntArray1555[anIntArray851[i_25_]]));
                }
            }
        }
        return class39_sub5_sub4_sub6;
    ...
    public void method925(int[] is, boolean bool, int[] is_26_, int i, int i_27_) {
        if (is == null) {
            is = new int[12];
            for (int i_28_ = 0; i_28_ < 7; i_28_++) {
                for (int i_29_ = 0; i_29_ < ImageImpl.anInt1584; i_29_++) {
                    Class39_Sub5_Sub6 class39_sub5_sub6 = FileLoader.method172(i_29_, 3);
    ...
    public void method926(boolean bool) {
        ...
        class45_33_.aLong849 = class45_33_.aLong849 + (long) (isMale ? 1 : 0);
        anIntArray848[5] = i;
        if (l != 0L && aLong849 != l) {
    ...
    public static JRuntimeException method930(Throwable throwable,
        ...
        if (!(throwable instanceof JRuntimeException)) {
            runtimeexception_sub1 = new JRuntimeException(throwable, string);
        } else {
    ...
    public void method931(boolean bool, int i, int i_43_) {
        ...
        if (bool) {
            ...
            i_44_ = GroundItem.anIntArrayArray2233[i_43_].length - 1;
        }
    ...
    static {
        ...
        aClass3_871 = (JString.create("You need a members account to login to this world)3"));
