...
public class Barrier {
    ...
    public static JString aClass3_164 = JString.create("This world is running a closed Beta)3");
    ...
    public static IndexedColorSprite[] method179(byte i) {
        IndexedColorSprite[] class39_sub5_sub10_sub4s = new IndexedColorSprite[JSocket.anInt302];
        for (int i_0_ = 0; i_0_ < JSocket.anInt302; i_0_++) {
            IndexedColorSprite class39_sub5_sub10_sub4 = (class39_sub5_sub10_sub4s[i_0_] = new IndexedColorSprite());
            class39_sub5_sub10_sub4.anInt2482 = Class13.anInt203;
            class39_sub5_sub10_sub4.anInt2483 = Class39_Sub5_Sub12.anInt1854;
            class39_sub5_sub10_sub4.offsetX = MsTimer.anIntArray1548[i_0_];
            class39_sub5_sub10_sub4.offsetY = SubNode.anIntArray1352[i_0_];
            class39_sub5_sub10_sub4.anInt2480 = Class39_Sub5_Sub9.anIntArray1799[i_0_];
            class39_sub5_sub10_sub4.anInt2481 = Class39_Sub14.anIntArray1512[i_0_];
            class39_sub5_sub10_sub4.colors = StillObject.anIntArray1460;
            class39_sub5_sub10_sub4.index = TraversalMap.aByteArrayArray517[i_0_];
        }
                                ...
                                if (i == 7) {
                                    ...
                                    if (i == 12) {
                                        ...
                                        if (i != 16) {
                                            if (i != 17) {
                                                if (i == 18) {
                                                    ...
                                                    if (i == 20) {
                                                        ...
                                                        Class37.method349(i_1_ ^ 0x2295,
                                                                (Class20.aClass3_387),
                                                                (Class14.aClass3_251),
                                                                (Class66.aClass3_1165));
                                                    } else if (i != 23) {
                                                        if (i != 24) {
                                                            if (i != 25) {
                                                                if (i == 26) {
                                                                    Class37
                                                                            ...
                                                                            (Queue.aClass3_977),
                                                                            (Class14.aClass3_258),
                                                                            (Class39_Sub5_Sub5.aClass3_1745));
                                                                } else if (i
                                                                        != 27) {
                                                                    Class37
                                                                            .method349(8845,
                                                        ...
                                                        Class37.method349(8845,
                                                                (Class23.aClass3_424),
                                                                (Class14.aClass3_248),
                                                                (TextConstants.aClass3_1264));
                                                    }
                                                } else {
                                                    Class37.method349(8845,
                                                            (TextConstants.aClass3_1593),
                                            ...
                                            Class37.method349(8845, Class30.aClass3_537,
                                                    Class14.aClass3_270,
                                                    (Class39_Sub5_Sub5.aClass3_1736));
                                        }
                                    } else {
                                        Class37.method349(8845,
                                                Class23.aClass3_427,
                                                Class14.aClass3_236,
                                                (AudioHandler.aClass3_1116));
                                    }
                                } else {
                                    Class37.method349(8845, Class4.aClass3_68,
                                            Class14.aClass3_257,
                                            (Projectile.aClass3_2196));
                                }
                            } else {
                                Class37.method349(8845,
                                        (StillGraphic.aClass3_2327),
                                        Class14.aClass3_243,
    ...
    static {
        ...
        aClass3_170 = (JString.create("Diese Betatest)2Welt ist nur f-Ur eingeladene"));
        aClass3_167 = (JString.create("Bitte schlie-8en Sie die momentan ge-Offnete Benutzeroberfl-=che)1 bevor Sie die (WRegelversto-8 melden(W Option benutzen"));
        mutePlayerOptionOffJstrEng = (JString.create("Moderator option: Mute player for 48 hours: <OFF>"));
        mutePlayerOptionOffJstr = mutePlayerOptionOffJstrEng;
        aClass3_166 = (JString.create("Wir vermuten)1 dass jemand Ihr Passwort kennt)3"));
